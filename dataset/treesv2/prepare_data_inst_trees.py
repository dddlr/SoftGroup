...
This differs from trees/prepare_data_inst_trees.py in that the
points of each chunk are centred on the origin, AND the coordinates
are scaled down to match that of the ScanNet data.
...
OUTPUT_DIRECTORY = '/csse/users/gwo21/uc-notes/honours/SoftGroup/dataset/treesv2/unsorted/'
...
def convert_tile(tile_number: str):
    filename = os.path.join(BASE_DIR, f'TreePointClouds/{tile_number}/CL2_BQ31_2019_1000_{tile_number}_treecrowns.laz')
    tree_directory = os.path.join(BASE_DIR, f'TreePointClouds/{tile_number}/CL2_BQ31_2019_1000_{tile_number}_trees')
    ...
    colors = np.stack((file.red, file.green, file.blue), axis=-1) / 127.5 - 1
...
if __name__ == '__main__':
    ...
    files = ('2135', '2136', '2137', '2235', '2236', '2436', '2645')
